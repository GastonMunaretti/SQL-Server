SELECT	B.CodigoCertificacion,
		A.CodigoOperacionItems + 4000000			AS CodogoReal,
...
WHERE L.IdTipoMovimiento= 3 --Salida


/*

SELECT  A.IdOperacion AS IdOperacion,
		Convert(TIME,A.TiempoReal) AS  HorarioProgramadoLlegada
FROM MOD_OperacionVuelosItems A
LEFT JOIN MOD_TipoMovimiento L
	ON A.IdTipoMovimiento = L.IdTipoMovimiento
WHERE L.IdTipoMovimiento= 1 -- Llegada*/